...
## Project Structure
    ...
    ├── testapiautostoryboa_90530  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_90530`
...
2. Clone this repo and `cd testapiautostoryboa_90530`
